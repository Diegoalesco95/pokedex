...
const Pokemons = () => {
  ...
  return (
    <section className="w-full py-4 flex flex-col sm:flex-row sm:mx-4">
        ...
        <table className="relative min-w-full divide-y divide-gray-200">
          <thead>
            <tr>
              <th
                scope="col"
                className="sticky top-0 px-4 py-2 bg-indigo-800 text-center text-xs font-medium text-gray-100 uppercase tracking-wider lg:text-base"
              >
                Name
              </th>
              <th
